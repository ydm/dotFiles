...
(define-minor-mode my-flymake-minor-mode
  "Simple minor mode which adds some key bindings for moving to the next and previous errors. See my-flymake-minor-mode-map for key binding information"
  nil nil :keymap my-flymake-minor-mode-map)
