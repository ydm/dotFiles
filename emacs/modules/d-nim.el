(y:module
 ...
 (defun d:nim-find-definition ()
   ...
   (when-let ((symbol (thing-at-point 'symbol)))
     (cl-loop
      for dir in (d:parent-directories default-directory)
      do (when-let (loc (or (d:nim-find-definition-location symbol dir nil t)
                            (d:nim-find-definition-location symbol dir nil nil)
                            (d:nim-find-definition-location symbol dir t t)
                            (d:nim-find-definition-location symbol dir t nil)))
         (cl-return (d:nim-goto loc))))))
